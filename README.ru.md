...
<div align="center">
<img src="screenshots/hero.png" alt="Попап TmuxPad: агенты сгруппированы по статусу, с быстрым ответом" width="380">
</div>
...
- 🎛️ **Режим панели** — компактная иконка с бейджем, который пульсирует оранжевым, когда агент ждёт
...
### Из исходников (сейчас рекомендуется)
...
Затем **правый клик по панели или рабочему столу → Добавить виджеты → найди «TmuxPad»**. Обновление: `git pull && make install`.

Или возьми готовый пакет из [последнего релиза](https://github.com/VladislavTsytrikov/tmuxpad/releases) и поставь:
...
**Требования:** KDE Plasma 6, tmux 1.9+. Для сборки переводов нужен `gettext`.
